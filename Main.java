import BangunDatar.com.persegi.panjang.PersegiPanjang;
import BangunDatar.com.setengah.lingkaran.SetengahLingkaran;
...
public class Main{
    public static void main(String[] args){
        ...
        System.out.println("");
        System.out.println("Luas Area Berwarna Ungu = " + luas_arsir);
    }
}
